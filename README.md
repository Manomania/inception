...
### Adminer
- [Link 1](https://hub.docker.com/_/adminer/)
- [Link 2](https://dev.to/codewithml/setup-adminer-with-docker-for-database-management-4dd2)

### Redis
- [Link 1](https://gaelbillon.com/installer-et-configurer-redis-pour-wordpress-en-5-minutes/)
